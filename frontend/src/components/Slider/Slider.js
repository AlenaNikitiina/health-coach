        ...
        <div className="swiper slider-swiper">
          <div className="swiper-wrapper">
            <div className="swiper-slide">
              <a data-fslightbox="slider__content" className='slider__link' href='image/reviewO.jpg'>
                <img className='slider__img' src={reviewO} alt="1" />
              </a>
            </div>
            <div className="swiper-slide">
              <a data-fslightbox="slider__content" className='slider__link' href="image/reviewOne.jpg">
                <img className='slider__img' src={reviewOne} alt="2" />
              </a>
            </div>
            <div className="swiper-slide">
              <a data-fslightbox="slider__content" className='slider__link' href="images/reviewOn.jpg">
                <img className='slider__img' src={reviewOn} alt="4" />
              </a>
            </div>
            <div className="swiper-slide">
              <a data-fslightbox="slider__content" className='slider__link' href="images/reviewOnee.jpg">
                <img className='slider__img' src={reviewOnee} alt="3" />
              </a>
            </div>
            <div className="swiper-slide">
              <a data-fslightbox="slider__content" className='slider__link' href="images/reviewtwo.jpg">
              <img className='slider__img' src={reviewtwo} alt="4" />
              </a>
            </div>
            <div className="swiper-slide">
              <a data-fslightbox="slider__content" className='slider__link' href="images/reviewTw.jpg">
                <img className='slider__img' src={reviewTw} alt="1" />
              </a>
            </div>
            <div className="swiper-slide">
              <a data-fslightbox="slider__content" className='slider__link' href="images/reviewT.jpg">
