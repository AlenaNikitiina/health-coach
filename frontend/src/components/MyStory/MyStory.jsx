    ...
    <section className='MyStory'>
      <div className='MyStory__content'>
        ...
        <div className='p'>
          ...
          <p> Я имею определенный багаж знаний и умений в области медицины, психологии и нутрициологии. Но с другой стороны-я обычный человек со своими страхами и вопросами. И самый главный вопрос-это здоровое отношение к жизни. Но к этому вопросу я шла весьма долго и интересно. Наверное.</p>
